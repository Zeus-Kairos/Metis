...
![](../../assets/images/ModDistortion_SweepTab1.png)
  ...
  4. Select Fixed from the Sweep Type pull down menu. The Fixed sweep measures a modulated signal with a fixed carrier LO frequency and power level. A Power sweep can be selected which sweeps the total power of the modulated signal at multiple power levels defined by a start/stop power level. [Learn more](Modulation_Distortion_Settings.md#Power_Sweep).
...
![](../../assets/images/ModDistortion_SA_Display.png)
  ...
  10. Select the Set Power At pull down to set the power at either the DUT In or DUT Out. Adjust the power using the up/down arrows or by double-clicking in the data entry field and entering the value using the displayed keypad.
  11. To set up a power supply, click on the DC Sources... button which accesses the standard dialog for controlling power supplies. [Learn more](../../S1_Settings/DC_Control.md).

  12. Click on the Apply button to apply the setting changes made in this dialog.
