...
# GetDataBufferCompact Method

* * *

#### Description

| Retrieves compact signal trace data (Y data) from the modulation distortion
measurement.  
---|---  
  
####  VB Syntax

| data = meas.GetDataBufferCompact DataBufferName  
...
| meas.GetDataBufferCompact "S21"  
  
#### [C++](../../Learning_about_COM/c++_and_the_com_interface.md) Syntax

| HRESULT GetDataBufferCompact(BSTR DataBufferName, VARIANT* Data );  
