...
[PutStandardByString](Put_StandardByString_Method.md) Puts standard
acquisition data into the Cal Set. Learn more about [Reading and Writing Cal
...
data |  (variant) Error term data in a two-dimensional array (0:1, 0:numpts-1). The data must be complex pairs. Note: See also [Put Standard Complex](Put_Standard_Complex_Method.md) on the ICalData2 interface to avoid using the variant data type.  
...
|  HRESULT putStandard(tagNACalClass stdclass, long ReceivePort, long
