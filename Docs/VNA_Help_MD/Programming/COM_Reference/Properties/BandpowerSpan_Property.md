...
## BandpowerSpan Property

* * *

#### Description

|  Sets and reads the frequency span of the band power marker. This area is
...
|  HRESULT get_BandpowerSpan(double* pVal) HRESULT put_BandpowerSpan(double
newVal)  
