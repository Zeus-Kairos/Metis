...
level |  (Double) - Start power level in dBm. Choose a value from min power to max power of the hardware.  
...
|  HRESULT get_StartPowerIn3DSweep(double* level) HRESULT
put_StartPowerIn3DSweep(double level)  
