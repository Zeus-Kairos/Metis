...
|  Sets or returns the LO start frequency value. This command can only be used
...
|  Print mixer.LOStartFrequency(1) 'prints the value of the first LO start
frequency  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_LOStartFrequency(long id, double *pVal) HRESULT
put_LOStartFrequency(long id,double newVal)  
