...
[PortMatchingCktModel](PortMatchingCktModel_Property.md). You can specify G,
G1, or G2 based on the selected port matching circuit model. Setting a value
...
|  fixture.PortMatching_G(port) = value  
...
|  fixture.PortMatching_G = .002 'Write  
value = fixture.PortMatching_G 'Read  
  
#### [C++](../../Learning_about_COM/c++_and_the_com_interface.md) Syntax

|  HRESULT get_PortMatching_G(short port double *pVal)  
