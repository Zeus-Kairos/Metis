...
|  Sets and returns the maximum power level for Safe Mode.  
---|---  
  
####  VB Syntax

|  RxLevel.PowerMax(srcPort) = value  
...
|  (Double) Maximum power level in dB.  
...
|  rxLevel.PowerMax (1) = 25 ' Write  
value = rxLevel.PowerMax 2' Read  
  
#### [C++](../../Learning_about_COM/c++_and_the_com_interface.md) Syntax

|  HRESULT get_PowerMax(long port, double* pVal); HRESULT put_PowerMax(long
port, double newVal);  
