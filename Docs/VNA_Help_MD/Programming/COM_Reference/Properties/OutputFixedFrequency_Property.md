...
|  Sets or returns the mixer output fixed frequency value. If you are changing
...
|  Print mixer.OutputFixedFrequency 'prints the output fixed frequency value
of the mixer.  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_OutputFixedFrequency(double *pVal) HRESULT
put_OutputFixedFrequency(double newVal)  
