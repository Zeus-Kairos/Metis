...
|  Sets and returns the stop power level of the Main tones. Use with IMD sweep
type= naIMDTonePowerSweep. When tone power is coupled, setting either F1 or F2
power sets both.  
---|---  
  
####  VB Syntax

|  object.TonePowerStop (tone) = value  
...
|  imd.TonePowerStop (naIMDF1Power) = 0 'Write  
value = imd.TonePowerStop (naIMDF2Power) 'Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_TonePowerStop (tagNAIMDTonePowerID naIMDF1, double * pVal);
