...
VNA when the [AutoOrient](AutoOrient_Property.md) property = False.  
---|---  
...
|  HRESULT put_EcalOrientation(long lModuleNum, BSTR orientation); HRESULT
get_EcalOrientation(long lModuleNum, BSTR *orientation);  
