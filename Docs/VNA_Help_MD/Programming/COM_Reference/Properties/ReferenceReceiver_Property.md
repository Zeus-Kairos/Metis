...
|  Sets and returns the receiver to be used with Receiver Leveling. To perform
receiver leveling with a ratioed receiver, use [ReceiverRatio
...
|  rxLevel.ReferenceReceiver (1) = "R1" ' Write rxLevel.ReferenceReceiver (1)
= "b2" ' Write  
value = rxLevel.ReferenceReceiver 2' Read  
  
#### [C++](../../Learning_about_COM/c++_and_the_com_interface.md) Syntax

|  HRESULT get_ReferenceReceiver( long port, BSTR* pVal); HRESULT
put_ReferenceReceiver( long port, BSTR newVal);  
