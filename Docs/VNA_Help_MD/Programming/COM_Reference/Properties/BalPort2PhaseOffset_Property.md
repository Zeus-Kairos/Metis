...
| balStim.BalPort2PhaseOffset = 10 'Write variable =
balStim.BalPort2PhaseOffset 'Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

| HRESULT get_BalPort2PhaseOffset (double *pVal) HRESULT
put_BalPort2PhaseOffset (double newVal)  
