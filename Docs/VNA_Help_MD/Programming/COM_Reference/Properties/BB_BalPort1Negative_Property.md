...
connected to the Negative side of the DUT's logical Port 1. Use [SetBBPorts
...
|  var = balTopology.BB_BalPort1Negative  
...
|  variable = balTop.BB_BalPort1Negative 'Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_BB_BalPort1Negative(long *bVal)  
