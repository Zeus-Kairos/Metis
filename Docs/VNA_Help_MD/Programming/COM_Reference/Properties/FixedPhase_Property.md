...
|  Write and read the fixed phase value. Must not be logarithmic sweep type.  
---|---  
  
####  VB Syntax

|  phase.FixedPhase(srcPort) = value  
...
|  (Double) Phase value in degrees. Choose a value between -360 and 360.  
...
|  phase.FixedPhase 1 = 15 ' Write  
value = phase.FixedPhase 2' Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_FixedPhase(long port, double* pVal); HRESULT
put_FixedPhase(long port, double newVal);  
