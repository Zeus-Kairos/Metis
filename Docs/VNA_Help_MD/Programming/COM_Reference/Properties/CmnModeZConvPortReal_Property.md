...
|  Sets the real part of the impedance value for the common port impedance
conversion function.  
---|---  
...
|  HRESULT get_CmnModeZConvPortReal( short portNum, double *pVal) HRESULT
put_CmnModeZConvPortReal( short portNum, double newVal)  
