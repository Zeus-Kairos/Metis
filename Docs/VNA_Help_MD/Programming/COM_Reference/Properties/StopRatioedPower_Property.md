...
|  Write and read the stop power ratioed value. Must also set
[SweepType](Sweep_Type_Property.md) to Power.  
---|---  
  
####  VB Syntax

|  phase.StopRatioedPower(srcPort) = value  
...
|  (Double) Stop power ratio value in dBc. Must be within the allowable range
of the VNA.  
...
|  phase.StopRatioedPower 1 = -1 ' Write  
value = phase.StopRatioedPower 2' Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_StopRatioedPower(long port, double* pVal); HRESULT
put_StopRatioedPower(long port, double newVal);  
