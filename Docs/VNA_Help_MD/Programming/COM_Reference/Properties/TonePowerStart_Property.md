...
|  Sets and returns the start power level of the Main tones. Use with IMD
sweep type= naIMDTonePowerSweep. When tone power is coupled, setting either F1
or F2 power sets both.  
---|---  
  
####  VB Syntax

|  object.TonePowerStart (tone) = value  
...
|  imd.TonePowerStart(naIMDF1Power) = 0 'Write  
value = imd.TonePowerStart(naIMDF2Power) 'Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_TonePowerStart(tagNAIMDTonePowerID naIMDF1, double * pVal);
