...
|  With a Single-ended - Balanced topology, returns the VNA port number that
...
|  var = balTopology.SB_BalPortPositive  
...
|  variable = balTop.SB_BalPortPositive 'Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_SB_BalPortPositive(long *bVal)  
