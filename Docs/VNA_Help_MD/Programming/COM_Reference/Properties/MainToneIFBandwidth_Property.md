...
|  Sets and returns the IF Bandwidth for measurement of the Main tones.  
---|---  
  
####  VB Syntax

|  imd.MainToneIFBandwidth = value  
...
|  imd.MainToneIFBandwidth = 2e3 'Write  
value = imd.MainToneIFBandwidth 'Read  
  
#### [C++](../../Learning_about_COM/c%2b%2b_and_the_com_interface.md) Syntax

|  HRESULT get_MainToneIFBandwidth(double *pVal)  
