# Cal All - 1-Port, 1-Channel, with ECal

' ' calibrate 1 port, no power, ECal ' system:preset; SYST:CAL:ALL:RESet
SYST:CAL:ALL:SEL 1  SYST:CAL:ALL:CHAN1:PORT:SEL 1 SYST:CAL:ALL:MCL:PROP:VAL
