# Sweep Commands - Gain Compression Measurement Class

Only the Main, Sweep Timing, and Source Control commands corresponding to the
Gain Compression measurement classes are documented here. The Segment Table
...
Number of Points |  | [SENSe:GCSetup:SWEep:FREQuency:POINts](GP-IB_Command_Finder/Sense/Gain_Compression.md#FreqPoints) | [NumberOfFrequencyPoints](COM_Reference/Properties/NumberOfFrequencyPoints_Property.md)  
